...
<form id="makepayemnt" class="mx-4" data-id="<?php echo htmlspecialchars($id); ?>">
    ...
    <div class="row">
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="Payement" name="Payement" placeholder="" >
        </div>
        <div class="col-md-4 mb-3">
            <div class="l1"><label>Total Paid</label></div>
            <input type="text" class="form-control" id="Payed" name="Payed" placeholder="" >
        </div>
        <div class="col-md-4 mb-3">
            <div class="l1"><label>Due Amount</label></div>
            <input type="text" class="form-control" id="due" name="due" placeholder="" >
        </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $("#makepayemnt").submit(function(e) {
            ...
            var formData = new FormData(this);
                formData.append('action', 'updatepay');
